...
Les liens entre note sont notés entre double crochets : 
```
[[note.id]]
```

- [Back links] (https://wiki.dendron.so/notes/2l54qrzcil50bufntojzbpo/) : ajouter un panel avec les back links
- Permettre la navigation entre notes par génération des liens markown correct 
```
[<note_description>](https://dendronline.com/View/<note_id>)
```
